...
<h3>Compare The Deadliness of Two Boroughs over the Time Periods 2021 and 2022.</h3>
<p>
...
<body>
  ...
  <p></p>
  <button type="button" onclick="getSignificance()">Compute Significance</button>
